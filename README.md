...
ipv6 is an issue - perhaps can force to use ipv4 addresses?


##  Tracker Annouce Response

seems like when ipv6 peers exist the tracker does not send compact.
compact only supports ipv4 ??
